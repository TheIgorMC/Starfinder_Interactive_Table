...
- **fleet**: `list_ship_models`, `get_ship_model`, `generate_ship_models`, `create_custom_ship_model`, `list_companies`, `get_company`, `generate_companies`, `create_company`, `update_company`, `delete_company`, `add_fleet_entry`, `remove_fleet_entry`, `add_notable_ship`, `update_notable_ship`, `remove_notable_ship`
